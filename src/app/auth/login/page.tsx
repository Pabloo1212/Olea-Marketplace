    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <h1 className="font-sans text-3xl font-bold text-olive-900 mb-2 tracking-tight">Welcome back</h1>
          <p className="text-olive-500 mb-8">Sign in to access your account and manage your orders</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-sm font-medium text-olive-800">Password</label>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-xs text-olive-400 font-medium">OR</span>
            <div className="flex-1 h-px bg-olive-200" />
          </div>
          ...
          <button className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black text-white rounded-xl text-sm font-medium hover:bg-gray-800 transition-colors">
      ...
      <div className="hidden lg:flex flex-1 bg-olive-900 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 max-w-md text-center px-10">
          ...
          <h2 className="font-sans text-3xl font-bold text-white mb-4 tracking-tight">The professional platform for olive oil procurement</h2>
          <p className="text-olive-300 leading-relaxed">
            Join hundreds of businesses that source premium EVOO directly from verified Mediterranean producers.
          </p>
        </div>
